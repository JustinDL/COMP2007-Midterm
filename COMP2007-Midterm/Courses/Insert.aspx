<%@ Page Title="CoursInsert" Language="C#" MasterPageFile="~/MasterPages/Frontend.Master" CodeBehind="Insert.aspx.cs" Inherits="COMP2007_Midterm.Courses.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="COMP2007_Midterm.Models.Cours" DefaultMode="Insert"
